...
func TestConfigCommandSurface(t *testing.T) {
	tests := [][]string{
		...
		{"sdk", "service", "okta", "add", "-f", "fused.yaml", "--version", "2026-07-01"},
		{"sdk", "operation", "okta", "add", "listLogEvents", "-f", "fused.yaml"},
		{"sdk", "operation", "okta", "remove", "listLogEvents", "-f", "fused.yaml"},
		{"mcp", "plan", "-f", "mcp.yaml"},
