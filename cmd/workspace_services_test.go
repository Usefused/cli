...
func TestWorkspaceServicesListQueryFiltersVisibleServices(t *testing.T) {
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		_, _ = w.Write([]byte(`{"data":{"workspaceServices":[{"service_id":"svc-github","service_name":"GitHub REST API","service_slug":"github","version":"v1"},{"service_id":"svc-stripe","service_name":"Stripe Billing","service_slug":"@stripe/payments","version":"v2"}]}}`))
	}))
	defer server.Close()
